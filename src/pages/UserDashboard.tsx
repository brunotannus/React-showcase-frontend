  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      <div className="my-8 flex-start flex flex-col items-center py-2">
        <div className="mb-4 overflow-hidden rounded h-20 w-20 shadow-md bg-tn-yellow">
          <img
      ...
      <div className="flex flex-wrap justify-center mb-6">
        <button
          ...
          className={`m-2 rounded w-[140px] ${
            activeTab === "newsletter" ? "btn-primary" : "btn-primary-inactive"
          }`}
        >
          Newsletter
        </button>
        ...
        <button
          ...
          className={`m-2 rounded w-[140px] ${
            activeTab === "userDetails" ? "btn-primary" : "btn-primary-inactive"
          }`}
        >
          User Details
        </button>
